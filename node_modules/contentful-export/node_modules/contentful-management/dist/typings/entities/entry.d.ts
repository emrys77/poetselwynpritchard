import type { CollectionProp, CursorPaginatedCollectionProp, DefaultElements, EntryMetaSysProps, KeyValueMap, MakeRequest, MetadataProps } from '../common-types';
 ...
 * @private
 */
export declare const wrapEntryTypeCursorPaginatedCollection: (makeRequest: MakeRequest, data: CursorPaginatedCollectionProp<EntryProps<KeyValueMap, unknown>>) => import("../common-types").CursorPaginatedCollection<Entry, EntryProps<KeyValueMap, unknown>>;
