 ...
 * @private
 */
export declare const wrapContentTypeCursorPaginatedCollection: (makeRequest: MakeRequest, data: CursorPaginatedCollectionProp<ContentTypeProps>) => import("../common-types").CursorPaginatedCollection<ContentType, ContentTypeProps>;
export {};
