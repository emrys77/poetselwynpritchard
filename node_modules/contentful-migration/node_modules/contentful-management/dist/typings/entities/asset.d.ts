 ...
 * @private
 */
export declare const wrapAssetTypeCursorPaginatedCollection: (makeRequest: MakeRequest, data: CursorPaginatedCollectionProp<AssetProps<{}>>) => import("../common-types").CursorPaginatedCollection<Asset, AssetProps<{}>>;
export {};
