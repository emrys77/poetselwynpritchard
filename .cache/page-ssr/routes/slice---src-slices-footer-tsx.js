exports.id = "slice---src-slices-footer-tsx";
exports.ids = ["slice---src-slices-footer-tsx"];
exports.modules = {
...
/***/ "./public/page-data/sq/d/507168964.json":
/*!**********************************************!*\
  !*** ./public/page-data/sq/d/507168964.json ***!
  \**********************************************/
/***/ ((module) => {
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"data":{"layout":null}}');
...
/* harmony export */ });
/* harmony import */ var _public_page_data_sq_d_507168964_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../public/page-data/sq/d/507168964.json */ "./public/page-data/sq/d/507168964.json");
...
function Footer() {
  const data = _public_page_data_sq_d_507168964_json__WEBPACK_IMPORTED_MODULE_0__.data;

  // Defensive access: protect against `data` or `data.layout` being null
  // (GraphQL can return null if the schema doesn't include `layout.footer`).
  const safeFooter = data && data.layout && data.layout.footer || {
    links: [],
    meta: [],
    copyright: ""
  };
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_ui__WEBPACK_IMPORTED_MODULE_2__.Box, {
    ...
    to: "/"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_ui__WEBPACK_IMPORTED_MODULE_2__.VisuallyHidden, null, "Home")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_ui__WEBPACK_IMPORTED_MODULE_2__.Space, null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_ui__WEBPACK_IMPORTED_MODULE_2__.Space, {
    size: 5
...
/***/ "./src/slices/footer.tsx?export=default":
/*!**********************************************!*\
  !*** ./src/slices/footer.tsx?export=default ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_components_footer__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
;
//# sourceMappingURL=slice---src-slices-footer-tsx.js.map